module models.hcm.entities.employee;

@safe:
import models.hcm;

class DHcmEmployeeEntity : DOOPEntity {
  mixin(EntityThis!("HcmEmployeeEntity"));
  ...
  override void initialize() {
    ...
    this
      .addValues([
        ...
        "pensionEnrollment": StringAttribute, //
        "pensionStart": StringAttribute, //
        "probationPeriod": StringAttribute, //
        "relocationReimbursement": StringAttribute, //
        "employeeDetailsEffective": StringAttribute, //
        "employeeDetailsExpiration": StringAttribute, //
